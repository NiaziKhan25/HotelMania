<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HotalMania._Default" %>
                            ...
                            <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item active">
                                        <img src="img/slider/first.jpg" alt="First slide" class="img-fluid">
                                    ...
                                    <div class="carousel-item">
                                        <img src="img/slider/islClub1.jpg" alt="Second slide" class="img-fluid">
                                        <div class="carousel-caption">
                                            <h4>Get discount!</h4>
                                            <br>
                                        </div>
